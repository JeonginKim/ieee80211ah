...
{
//	std::cout << "[JI] Print is called" << std::endl;

  PacketMetadata::ItemIterator i = m_metadata.BeginItem (m_buffer);
  while (i.HasNext ())
    {
//    std::cout << "[JI] Print is called1" << std::endl;
      PacketMetadata::Item item = i.Next ();
      if (item.isFragment)
        {
//            std::cout << "[JI] Print is called2" << std::endl;
          switch (item.type) {
        ...
        {
//            std::cout << "[JI] Print is called3" << std::endl;
          switch (item.type) {
            case PacketMetadata::Item::PAYLOAD:
...
//      std::cout << "[JI] Print is called4" << std::endl;
#if 0
