...
namespace ns3 {
	...
	extern Time g_prevTime[3000];
	extern Time g_prevTime_ack[3000];
	extern int g_cw[3000];
	extern int g_freeze[3000];

	extern int g_contentionCount;
	extern int g_receviedCount;
	extern int g_statRawSlot[3000];
	...
	extern Time g_sendTime[3000];

	extern bool g_bIsInsideBackoff[3000];
