...
{
//	printf("[JI] SetBitmapControl is called\n");
...
//  printf("[JI] setPartialVBitmap m_length = %d offset = %d control = %d offcont = %d\n", m_length, offset, control, offcont);
  ...
  {
//    printf("[JI] setPartialVBitmap len = %d subblock = %c\n", len, *subblock );
...
{
//	printf("[JI] GetPartialVBitmap is called\n");
...
{
//	printf("[JI] TIM DTIMCount : %d, DTIMPeriod : %d, BitmapControl : %d, m_length : %d\n", m_DTIMCount, m_DTIMPeriod, m_BitmapControl, m_length);
//	printf("===");
//	for(int i = 0; i < m_length; i++)
//	{
//		printf(" %c ", m_partialVBitmap[i]);
//	}
//	printf("===");
