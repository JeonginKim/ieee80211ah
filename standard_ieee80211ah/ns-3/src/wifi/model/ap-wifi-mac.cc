...
//	  std::cout << "[JI]====================SendOneBeacon is called================" << m_slotCrossBoundary << std::endl;
	 ...
	 raw.SetReservedInfo(0x77);
	  ...
	  printf("[JI_LOG] === SendOneBeacon is called === aid_start : %d aid_end : %d g_contention : %d g_suceeseed : %d m_rawGroupInterval : %d m_totalStaNum : %d ", 
			  aid_start, aid_end, g_contentionCount, g_receviedCount,m_rawGroupInterval, m_totalStaNum);
