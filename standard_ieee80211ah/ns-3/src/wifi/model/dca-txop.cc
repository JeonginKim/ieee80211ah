...
{
//	printf("[JI_LOG] AccessAllowedIfRaw is called : %d\n", allowed);
...
DcaTxop::RestartAccessIfNeeded (void)
{
  ...
  if ((m_currentPacket != 0
    ...
    {
//    printf("[JI] DcaTxop::StartAccessIfNeededRaw is called\n");
...
DcaTxop::StartAccessIfNeeded (void)
{
  ...
  if (m_currentPacket == 0
      ...
      && AccessIfRaw)      // always TRUE outside RAW
    {
//	  printf("[JI] DcaTxop::StartAccessIfNeeded is called\n");
      m_manager->RequestAccess (m_dcf);
    }
}
...
{
//	printf("[JI_LOG] DcaTxop::RawStart is called\n");
...
{
//	printf("[JI] DcaTxop::OutsideRawStart is called\n");
//  printf("[JI_LOG] DcaTxop::OutsideRawStart is called true\n");
...
{
//	printf("[JI_LOG] NotifyAccessGranted is called\n");
 ...
 // 	  	  printf("[JI] StartTransmission is called(NeedFragmentation)\n");
      ...
      else
        {
          ...
          params.DisableNextData ();
//   	  	  printf("[JI] StartTransmission is called\n");
...
{
//	printf("[JI_LOG] StartNext is called\n");
